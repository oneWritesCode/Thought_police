  ...
  return (
    ...
    >
      <div className="relative w-96 h-64 mx-auto">
        {/* Card Background - Always dark for badge authenticity */}
        <div className="absolute inset-0 bg-gradient-to-br from-slate-800 via-slate-900 to-black rounded-2xl shadow-2xl transform-gpu">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(0,121,211,0.1),transparent_70%)] rounded-2xl"></div>
        </div>
        ...
        {/* Card Content - Always light text on dark background */}
        <div className="relative z-10 p-6 h-full flex flex-col text-white">
          ...
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div className="flex-1">
              <div className="text-lg font-bold text-white">Officer {user.redditUsername}</div>
