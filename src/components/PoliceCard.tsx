  ...
  return (
    ...
    >
      <div className="relative w-96 h-64 mx-auto">
        ...
        <div className="relative z-10 p-6 h-full flex flex-col text-white">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-2">
              <Shield className="h-6 w-6 text-reddit-orange drop-shadow-lg" />
          ...
          <div className="flex items-center space-x-4 mb-4">
            <div className="relative">
              <img
                ...
                className="w-16 h-16 rounded-full border-2 border-reddit-orange shadow-lg ring-2 ring-white/20"
              />
              <div className="absolute -top-1 -right-1 w-6 h-6 bg-reddit-orange rounded-full flex items-center justify-center shadow-lg">
                <Star className="h-3 w-3 text-white drop-shadow-sm" />
              </div>
            </div>
            <div className="flex-1">
              <div className="text-lg font-bold text-white drop-shadow-md">Officer {user.redditUsername}</div>
              <div className="text-sm text-slate-300 dark:text-slate-200 transition-colors duration-200" style={{ color: rank.color }}>
                {rank.name}
              </div>
          ...
          <div className="grid grid-cols-3 gap-4 mb-4">
            <div className="text-center bg-black/20 dark:bg-black/30 rounded-lg p-2 backdrop-blur-sm transition-colors duration-200">
              <div className="text-lg font-bold text-reddit-orange drop-shadow-md">{user.totalPoints}</div>
              <div className="text-xs text-slate-400 dark:text-slate-300 transition-colors duration-200">Points</div>
            </div>
            <div className="text-center bg-black/20 dark:bg-black/30 rounded-lg p-2 backdrop-blur-sm transition-colors duration-200">
              <div className="text-lg font-bold text-reddit-blue drop-shadow-md">{user.badgeCount}</div>
              <div className="text-xs text-slate-400 dark:text-slate-300 transition-colors duration-200">Badges</div>
            </div>
            <div className="text-center bg-black/20 dark:bg-black/30 rounded-lg p-2 backdrop-blur-sm transition-colors duration-200">
              <div className="text-lg font-bold text-green-400 drop-shadow-md">{user.casesSolved}</div>
          ...
          <div className="flex items-center justify-between mt-auto">
            ...
            <div className="flex items-center space-x-2">
              <QrCode className="h-8 w-8 text-slate-400 dark:text-slate-300 transition-colors duration-200" />
        ...
        <div className="absolute top-4 right-4 w-8 h-8 border-2 border-reddit-orange/30 dark:border-reddit-orange/50 rounded-full animate-ping transition-colors duration-200"></div>
        <div className="absolute bottom-4 left-4 w-6 h-6 border border-reddit-blue/30 dark:border-reddit-blue/50 rounded-full animate-pulse transition-colors duration-200"></div>
        
        {/* Additional glow effects for dark mode */}
        <div className="absolute top-2 left-2 w-4 h-4 bg-reddit-orange/20 dark:bg-reddit-orange/40 rounded-full blur-sm animate-pulse transition-colors duration-200"></div>
        <div className="absolute bottom-2 right-2 w-3 h-3 bg-reddit-blue/20 dark:bg-reddit-blue/40 rounded-full blur-sm animate-pulse transition-colors duration-200"></div>
      </div>
    </motion.div>
  );
};
